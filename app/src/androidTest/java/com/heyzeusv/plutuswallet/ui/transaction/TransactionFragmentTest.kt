...
class TransactionFragmentTest {
    ...
    fun displayBlankTransaction() {
        ...
        onView(withId(R.id.tran_repeating)).check(matches(isNotChecked()))
        onView(withId(R.id.frequencyTextView)).check(matches(not(isDisplayed())))
    ...
    fun displayGivenExpenseTransaction() {
        ...
        onView(withId(R.id.tran_repeating)).check(matches(isChecked()))
        onView(withId(R.id.frequencyTextView)).check(matches(isDisplayed()))
