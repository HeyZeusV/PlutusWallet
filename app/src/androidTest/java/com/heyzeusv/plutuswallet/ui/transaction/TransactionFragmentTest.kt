...
//        onView(withId(R.id.tran_type_chips)).check(matches(chipSelected(R.id.tran_expense_chip)))
        ...
        onView(withId(R.id.tran_period)).check(matches(withEffectiveVisibility(ViewMatchers.Visibility.INVISIBLE)))
        onView(withId(R.id.tran_frequency)).check(matches(withEffectiveVisibility(ViewMatchers.Visibility.INVISIBLE)))
    }
