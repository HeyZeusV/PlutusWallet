...
class DatabaseTest {
    ...
    inner class CategoryQueries {
        ...
        fun getCategoryNamesByType() {
            ...
            val expected : MutableList<String> = mutableListOf("Car", "Food")
    ...
    inner class TransactionQueries {
        ...
        fun getDistinctAccounts() {
            ...
            val expected : List<String> = listOf("Cash", "Debit Card", "Credit Card")
        ...
        fun getDistinctCatsByType() {
            ...
            val expected : List<String> = listOf("Food", "Entertainment")
        ...
        fun getFutureTransactions() {
            ...
            assertEquals(expected, runBlocking { tranDao.getFutureTransactions(Date(86400000 * 3)) })
        }
